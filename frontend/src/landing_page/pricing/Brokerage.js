  ...
  return (
    <div className="container ps-5 pe-5">
      <div className="row mb-5">
        <div className="tabs">
          <a className="custom-a-tab">Equity</a>
          <a className="custom-a-tab">Currency</a>
          <a className="custom-a-tab">Commodity</a>
        </div>
        <hr className="mt-2" />
        <table>
          <thead>
          ...
          <tbody>
            ...
            <tr>
              <td>STT/CTT</td> <td>0.1% on buy & sell</td>{" "}
              <td>0.025% on the sell side</td> <td>0.02% on the sell side</td>
              <td>
                <ul>
                  <li>
        ...
        <p className="text-center bro-link">
          <a href="#" style={{ textDecoration: "none" }}>
            Calculate your costs upfront
          </a>{" "}
          using our brokerage calculator
        </p>
        <p className="p-bro">Disclaimer</p>
